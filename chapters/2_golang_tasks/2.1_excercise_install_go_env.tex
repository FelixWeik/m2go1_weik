...
Further details on the installation and especially the path variables can be found in chapter \autoref{sec:go_environment_variables} on path variables in Ubuntu.