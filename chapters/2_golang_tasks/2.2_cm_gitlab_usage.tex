...
The subgroup structure in figure \ref*{fig:screendump_subgroupStructure} shows the Golang repository.
This repository consists out of three folders:
\begin{enumerate}
...
After committing the changes, the changes are pushed to the remote repository, which then become visible on GitLab as shown in figure \ref*{fig:screendump_readme}.
