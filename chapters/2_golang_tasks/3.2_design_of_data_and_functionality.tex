...
%//TODO entity diagram methoden unten, signatur bekommt kein rental sondern gibt zurück, sichtbarkeit einfügen
...
%//TODO Signatur anpassen, wird funktionlität benötigt?
...
%//TODO Fließtext statt Stichpunktef
\begin{itemize}
    \item The car exists
...
%//TODO Tabellen aus der Aufgabenstellung übernehmen und mit den hinzugefügten Daten füllen
-- Does this need to be done? --

\subsubsection*{Write YAML Code}
%//TODO Tabelle von oben übernehmen und in YAML umschreiben
