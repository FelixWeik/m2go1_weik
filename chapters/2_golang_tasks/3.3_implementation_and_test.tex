...
%//TODO Einführung zu Structs, struct mit großem Buchstaben wird exportiert wie public, kleiner Buchstabe ist private
...
%//TODO erklären wie das printen funktioniert, key-value pairs im struct (werden auch ausgegeben), struct structs müssen implementiert werden, sachen wurden noch nicht implementiert, was macht der & operator
...
\end{figure}
%//TODO Code von Rental initialisierung einfügen
