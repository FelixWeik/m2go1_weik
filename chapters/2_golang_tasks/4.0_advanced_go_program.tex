...
After analyzing the use cases presented in section 3.1 of the goLang tasks in table 4.1, the parameters displayed in \autoref{tab:cli_parameters_car_rental_cli} are needed.
...
\begin{table}
      ...
      \begin{tabular}{|p{4cm}|p{2cm}|p{4cm}|p{5cm}|}
            ...
            \hline
            Register as Customer & register & CustomerID, Name & CustomerID / Failure \\
            \hline
            Rent a Car & rent & RentalID, CustomerID, CarID, StartDate, EndDate & RentalID / Failure \\
            \hline
            Cancel Rental & cancel & RentalID, CustomerID & RentalID / Failure \\
            \hline
            Deregister as Customer & deregister & CustomerID & CustomerID / Failure \\
            \hline
      \end{tabular}
\end{table}
