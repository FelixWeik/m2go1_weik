...
% Implement the entity mapper ConvertCustomerToCustomerPersistenceEntity. Use the mapper in the file CarRentalRepository to create a new customer. Describe why the mapper is required.
...
% Implement the operation used by the CLI to create a new customer. Use the repository and implement the necessary logic. Do not forget to implement validations
