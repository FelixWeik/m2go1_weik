...
The finished implementation can be seen on GitLab commit \texttt{2ada728e97eb6c486964a37ea8aed4086ce47066} and in \autoref{lst:addCarMethodInMemoryRepository}.
