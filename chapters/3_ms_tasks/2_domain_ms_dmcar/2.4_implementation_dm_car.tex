...
This is done by the \texttt{CarRepositoryInterface} encapsulating the implementation of the persistence of cars.
...
The \texttt{CarRepositoryInterface} is used to create the \texttt{CarOperations} object, which implements the interface. %//TODO nochmal nachprüfen ob das stimmt
