...
As modeled in the API diagram \texttt{AM-RentalManagementV1.1}, the \texttt{Customers} collection holds two functions, \texttt{registerCustomer} and \texttt{deregisterCustomer}.
